...
parser = argparse.ArgumentParser(
    description="Slowloris, web siteleri için düşük bant genişliği saldırı aracı"
)
...
parser.add_argument(
    ...
    dest="useproxy",
    action="store_true"
     #Bağlanmak için bir SOCKS5 proxy kullanılır
)
parser.add_argument(
...
parser.add_argument(
    ...
    dest="https",
    action="store_true"
  #İstekler için HTTPS kullanılır
)
parser.add_argument(
    "--sleeptime",
    dest="sleeptime",
    default=15,
    type=int
   #Gönderilen her başlık arasındaki uyku zamanı.
)
...
if args.useproxy:
    ...
    try:
        ...
        logging.info("Bağlanmak için SOCKS5 proxy'si kullanma...")
    except ImportError:
        logging.error("Proxy Kitaplığı Kullanılamıyor!")
...
user_agents = [
    ...
    "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_1) AppleWebKit/602.2.14 (KHTML, like Gecko) Version/10.0.1 Safari/602.2.                                                                                                                                                                                                   x4",
